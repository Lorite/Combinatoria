...
public class Main {
	...
	*/
	...
	public static void inputUsuario() {
		...
		boolean datoValido = false;
		while (datoValido == false) {
			int numero = leerEnteroDeTeclado("Introduzca el número hasta el que desea buscar números primos: ");
	...
	public static int calcularCombinacionesOrdinarias(int m, int n) {
		int total = 0;
	...
	public static ArrayList<ArrayList<String>> generarCombinacionesOrdinarias(ArrayList<String> A, int n) {
...
//		}
	...
	public static void main(String[] args) {
		...
		int totalVariacionesOrdinarias = calcularCombinacionesOrdinarias(m, n);
		...
		ArrayList<ArrayList<String>> conjuntoVariacionesOrdinarias = 
				generarCombinacionesOrdinarias(A, n);
