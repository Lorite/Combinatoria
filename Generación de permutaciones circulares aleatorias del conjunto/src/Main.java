...
public class Main {
	...
	*/
	...
	public static int calcularPermutacionesCirculares(int n) {
		int total = 0;
	...
	public static ArrayList<ArrayList<String>> generarPermutacionesCirculares(ArrayList<String> A, int n) {
...
//		}
	...
	public static void main(String[] args) {
		...
		int totalVariacionesOrdinarias = calcularPermutacionesCirculares(n);
		...
		ArrayList<ArrayList<String>> conjuntoVariacionesOrdinarias = 
				generarPermutacionesCirculares(A, n);
