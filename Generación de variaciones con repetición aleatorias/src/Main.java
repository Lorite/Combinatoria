...
public class Main {
	...
	*/
	...
	public static int calcularVariacionesConRepeticion(int m, int n) {
		int total = 0;
		
		// fórmula
		total = (int) Math.pow(m,n);
		
		return total;
	}
	
	public static ArrayList<ArrayList<String>> generarVariacionesConRepeticion(ArrayList<String> A, int n) {
...
//		}
	...
	public static void main(String[] args) {
		...
		int totalVariacionesOrdinarias = calcularVariacionesConRepeticion(m, n);
		...
		ArrayList<ArrayList<String>> conjuntoVariacionesOrdinarias = 
				generarVariacionesConRepeticion(A, n);
