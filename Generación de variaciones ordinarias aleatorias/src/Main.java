...
public class Main {
	...
	*/
	...
	public static int calcularVariacionesOrdinarias(int m, int n) {
		int total = 0;
		
		// fórmula
		total = factorial(m)/factorial(m-n);
		
		return total;
	}
	
	public static ArrayList<ArrayList<String>> generarVariacionesOrdinarias(ArrayList<String> A, int n) {
...
//		}
	...
	public static void main(String[] args) {
		...
		int totalVariacionesOrdinarias = calcularVariacionesOrdinarias(m, n);
		...
		ArrayList<ArrayList<String>> conjuntoVariacionesOrdinarias = 
				generarVariacionesOrdinarias(A, n);
